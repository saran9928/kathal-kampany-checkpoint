...
export default function SiteHeader({ active = 'experience' }: { active?: 'experience' | 'services' }) {
  return <header className="site-header">
    <a className="brand" href="/" aria-label="The Kathal Kampany home"><span className="brand-mark" aria-hidden="true"><img src="/images/kathal-transparent-logo.png" alt="" width="1147" height="2048"/></span><span>THE KATHAL<br/><b>KAMPANY</b></span></a>
